...
namespace FaceIn.Common
{
    ...
    /// </summary>
    public class FlowParamCommand : ICommand, IFlowParamCommand
    {
        /// <summary>
        ...
        public FlowParamCommand(Predicate<object> canExecute)
        {
        ...
        /// </summary>
        public event ParamAction ExecuteAction = delegate { };
